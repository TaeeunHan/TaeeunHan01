...
mapOption = {
  center: new kakao.maps.LatLng(37.499516, 127.0313815), //지도의 중심좌표
  level: 3 //지도의 확대레벨
};
//보여질 지도의 옵션을 설정
...
var markerOptions = [
  {
    title: "본점", //제목
    latlng: new kakao.maps.LatLng(37.499516, 127.0313815), //지도의 위치
    imgSrc: 'img/marker1.png', //마커이미지 경로
    imgSize: new kakao.maps.Size(48, 48), //마커 이미지 크기
    imgPos: { offset: new kakao.maps.Point(25, 55) }, //마커 이미지 위치
    button: branch_btns[0], //마커와 매치할 버튼의 인덱스
  },
  {
    title: "지점1",
    latlng: new kakao.maps.LatLng(37.3941538, 126.9628816),
