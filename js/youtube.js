...
const playlistId = 'PL5cz5X86j60U-orIQbE7sHnJrEC7T-CwX';
const num = 6;
...
//이벤트위임을 해서 vidList에 클릭이벤트를 걸어준다 - 이구문은 미래시 팝이 있어야 성립하는 구문
//이 구문은 위의 이벤트 즉 pop이라는 figure태그가 존재하지 않는다면 무시되는 구문
vidList.addEventListener("click", (e) => {
